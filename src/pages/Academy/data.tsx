...
export const AcademyData=[
    {
        coverimg:coverimg,
        icon:g5ic,
        groupName:"Prickly Piranhas",
        desc:"There are critical thinkers in this bunch"
    },
    {
        coverimg:group1,
        icon:g4ic,
        groupName:"Young Scientists",
        desc:"Well, the name says it all"
    },
    {
        coverimg:group2,
        icon:g3ic,
        groupName:"Study Buddies",
        desc:"Education is one thing no one can take away from you"
    },
    {
        coverimg:group3,
        icon:g2ic,
        groupName:" Canny Cougars",
        desc:" You are quick witted thinkers"
    },{
        coverimg:group4,
        icon:g1ic,
        groupName:"Rapid Readers",
        desc:"A group of students who are above their reading grade level"
    }
]